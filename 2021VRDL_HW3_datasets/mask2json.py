...
dataPath = '/home/yuhsi44165/NYCU/G2/VRDL/HW3/2021VRDL_HW3_datasets/'

# Training and testing dataset directory path
IMAGE_DIR = dataPath + 'train'
...
def get_coco_test():
    json_fp = open('test_img_ids.json', 'r')
...
json_train_file = dataPath + 'train.json'
...
json_test_file = dataPath + 'test.json'
